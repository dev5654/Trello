...
public class TaskDto extends GenericDto {
    ...
    public TaskDto(Long id, String tittle, String description, ProjectColumn projectColumn, Instant deadline, Integer orders, Level level, Instant createdat, Long createby, Instant updatedat, Long updateby) {
        super(id);
        this.tittle = tittle;
